# 前端适配指南（v1.4 选集卡片 + 多模态）

> 文档版本：**v1.4**  
> 更新日期：2026-09-09  
> 适用范围：Agent Crawler 后端 ↔ 前端  
> 关联文档：  
> - **`2026-09-09_接口文档_1.md`（v1.4 选集卡片，给前端的独立整改说明）**  
> - `2026-09-03_接口文档_1.md`（v1.0 基础对话 / SSE 协议）  
> - `2026-09-04_接口文档_1.md`（v1.1 资源块 video / link / image）
...
| 日期 | 版本 | 说明 |
|------|------|------|
| 2026-09-09 | **v1.4** | 新增 `resource_bundle` 按线路分组的选集卡片；LLM 不再在 `text_delta` 中倾倒播放 URL |
